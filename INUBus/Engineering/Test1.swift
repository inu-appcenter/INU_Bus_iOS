...
class Test1: UIViewController {
  ...
  var url: String {
    return Server.address.rawValue + StringConstants.arrivalInfo.rawValue
  }
...
extension Test1: ReloadDataDelegate {
...
extension Test1: UITableViewDelegate {
  // cell의 높이
...
extension Test1: UITableViewDataSource {
  // section의 개수
